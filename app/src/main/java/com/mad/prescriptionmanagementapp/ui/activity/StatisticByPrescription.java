...
public class StatisticByPrescription extends AppCompatActivity {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position > 0) { // Nếu chọn thuốc (không phải "Chọn thuốc...")
                    ...
                    Toast.makeText(StatisticByPrescription.this, "Đã chọn: " + selectedItem, Toast.LENGTH_SHORT).show();
    ...
    private void showDatePickerDialog(final TextView targetTextView, boolean isStartDate) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(StatisticByPrescription.this,
                (view, year1, month1, dayOfMonth1) -> {
                    ...
                    if (isStartDate) {
                        ...
                        if (endDateCalendar.getTimeInMillis() > 0 && calendar.after(endDateCalendar)) {
                            Toast.makeText(StatisticByPrescription.this, "Ngày bắt đầu không thể sau ngày kết thúc!", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        if (calendar.before(startDateCalendar)) {
                            Toast.makeText(StatisticByPrescription.this, "Ngày kết thúc không thể trước ngày bắt đầu!", Toast.LENGTH_SHORT).show();
                            return;
                        }
