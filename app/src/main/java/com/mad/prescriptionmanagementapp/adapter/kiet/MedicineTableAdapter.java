...
import com.mad.prescriptionmanagementapp.data.model.kiet.MedicineTableItem;
...
public class MedicineTableAdapter extends RecyclerView.Adapter<MedicineTableAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_medicine_table_kiet, parent, false);
